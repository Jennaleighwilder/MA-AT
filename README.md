...
**Court-Defensible Jury Analysis Platform**
...
This repository contains the product landing page. MA'AT is proprietary licensed software.
...
- Complete software package delivered directly
- Implementation support
- Training materials
- Court-safe documentation templates

## Who It's For

MA'AT is designed for trial teams:
